<?php
    ...
    if(isset($_POST['insert_brand'])){
        ...
        // select data from database to check if brand is already present in the database
...
<form action="" method="post" class="mb-2">
    ...
    <div class="input-group w-10 mb-2 m-auto">
        <input type="submit" class="btn btn-info mb-3 px-3" style="background: #ff9966; color: #000;" name="insert_brand" value="Insert Brands">
    </div>
</form>